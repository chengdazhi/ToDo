...
/**
 * shows when user clicks the adding notification.
 * only creates new task.
 */
public class DialogEventActivity extends ActionBarActivity {
    ...
    class LabelListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            LinearLayout linearLayout = new LinearLayout(DialogEventActivity.this);
            linearLayout.setPadding(50, 20, 20, 20);
            TextView labelColor = new TextView(DialogEventActivity.this);
            labelColor.setText(getString(R.string.label_color));
            TextView labelName = new TextView(DialogEventActivity.this);
            if(position < labelList.size()) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("ToDoDialog", getIntent().toString());
    ...
    private void initViews() {
        ...
        cancelImageView = (ImageView) this.findViewById(R.id.dialog_cancel_imageview);
        okImageView = (ImageView) this.findViewById(R.id.dialog_new_imageview);
        ...
        labelNameTextview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                labelListView = new ListView(DialogEventActivity.this);
                labelListView.setAdapter(adapter);
                final AlertDialog dialog = new AlertDialog.Builder(DialogEventActivity.this).setTitle(getString(R.string.choose_label))
        ...
        okImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(eventEditText.getText().toString().trim().equals("")){
                    ...
                    Animation shake = AnimationUtils.loadAnimation(DialogEventActivity.this, R.anim.shake);
    ...
    class MyDateAndTimeOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            new DatePickerDialog(DialogEventActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
                public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                    ...
                    if(!isTimeDialogShown[0]) {
                        new TimePickerDialog(DialogEventActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
